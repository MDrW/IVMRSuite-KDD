...
class AsyncVectorEnv_Patch(VectorEnv):
    ...
    def __init__(
        ...
        self.num_items = dummy_env.max_num_items
        self.num_boxes = dummy_env.max_num_boxes
        self.num_eval_data = dummy_env.num_eval_data
    ...
    # def get_vm_mask(self):
    #     masks = []
    #     for idx, env_fn in enumerate(self.env_fns):
    #         env_instance = env_fn()
    #         mask = env_instance.get_vm_mask()
    #         masks.append(mask)
    ...
    def _raise_if_errors(self, successes):
        ...
        for _ in range(num_errors):
            ...
            print(f"Debug: error_info = (index: {index}, exctype: {exctype.__name__}, value: {value})")
            logger.error(
...
def _worker_shared_memory(index, env_fn, pipe, parent_pipe, shared_memory, error_queue):
    ...
    try:
        ...
        error_queue.put((index, type(e), traceback.format_exc()))
        pipe.send((None, False))
        # error_queue.put((index, type(e), str(e)))  # Changed this line
        # # error_queue.put((index,) + sys.exc_info()[:2])
        # pipe.send((None, False))
    finally:
        env.close()
