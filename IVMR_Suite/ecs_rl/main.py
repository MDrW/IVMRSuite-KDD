...
def parse_args():
    ...
    parser.add_argument("--gym-id", type=str, default="ecs-v1", # generalizer-v1
...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, envs, obs_info_pm, obs_info_all_vm, obs_info_num_steps, obs_info_num_vms,
        ...
        return selected_vm, vm_log_prob, vm_cat.entropy(), selected_pm, pm_log_prob, \
               pm_cat.entropy(), critic_score, pm_mask
...
if __name__ == "__main__":
    ...
    for update in pbar:
        ...
        for step in range(0, num_steps):
            ...
            with torch.no_grad():
                vm_action, vm_logprob, _, pm_action, pm_logprob, _, value, action_mask \
        ...
        for epoch in range(args.update_epochs):
            ...
            for index, start in enumerate(range(0, args.batch_size, args.minibatch_size)):
                ...
                _, vm_newlogprob, vm_entropy, _, pm_newlogprob, pm_entropy, newvalue, _ = agent.get_action_and_value(
                    envs,
                    b_obs_pm[mb_inds],
                    b_obs_vm[mb_inds],
