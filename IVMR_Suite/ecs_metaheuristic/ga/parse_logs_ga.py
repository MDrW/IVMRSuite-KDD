...
if __name__ == '__main__':
    root_path = '../../results/ecs_metaheuristic_ga'
    placement_root_path = f'{root_path}/logs_ecs_data_mig'
    move2seq_root_path = f'{root_path}/moveseq_ecs_data_mig'
    save_path = f'{root_path}/results/ga_ecs_data.csv'
