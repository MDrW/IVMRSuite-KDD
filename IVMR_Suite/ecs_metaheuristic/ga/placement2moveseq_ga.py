...
if __name__ == '__main__':
    ...
    parser.add_argument("--sol_save_root_path", type=str, default=f'../../results/ecs_metaheuristic_{algorithm}/placement_ecs_data_mig')
    parser.add_argument("--logger_root_path", type=str, default=f'../../results/ecs_metaheuristic_{algorithm}/moveseq_ecs_data_mig')
